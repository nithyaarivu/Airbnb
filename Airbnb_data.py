...
st.set_page_config(page_title="AirBnb-Analysis by Nithya!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    df = pd.read_csv(filename, encoding="ISO-8859-1")
     ...
     os.chdir(r"C:\Users\smm\Documents\Python Scripts\guvi")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"NITHYA"}')
    mail = (f'{"Mail :"}  {"nithyaarivalagan1991@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {

        "GITHUB": "https://github.com/nithyaarivu/Airbnb",
        }

    col1, col2 = st.columns(2)
    col1.image(Image.open("home.jpg"), width=300)
